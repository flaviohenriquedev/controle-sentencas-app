...
import {FormularioCadastroEmpresas} from "@/components/pages/bi_sentencas/empresas/FormularioCadastroEmpresas";
...
export function EmpresasComponente() {
    ...
    return (
        <Pagesection.Container titulo={tituloPagina}
                               ...
                               componenteCadastro={<FormularioCadastroEmpresas entidade={entidade}
                                                                               editavel={editavel}/>}
        >
            <TabelaComponente colunas={colunasTabelaEmpresas()}
