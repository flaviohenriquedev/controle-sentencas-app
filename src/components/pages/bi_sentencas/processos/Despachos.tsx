...
export function Despachos({ processo }: Props) {
    ...
    function handleSelecionarDespacho(despacho: Despacho) {
        ...
        openModal(`cadastro_despacho_processo`)
    }
    ...
    async function handleSalvarDespacho() {
        ...
        setDespacho(new Despacho())
        closeModal('cadastro_despacho_processo')
    }
    ...
    return (
        <>
            ...
            <Modal.Container id={`cadastro_despacho_processo`}
