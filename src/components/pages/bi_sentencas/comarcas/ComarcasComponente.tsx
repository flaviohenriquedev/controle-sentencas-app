...
import {ComarcasFormularioCadastro} from "@/components/pages/bi_sentencas/comarcas/ComarcasFormularioCadastro";
...
export function ComarcasComponente() {
    ...
    return (
        <Pagesection.Container titulo={tituloPagina}
                               ...
                               componenteCadastro={<ComarcasFormularioCadastro entidade={entidade}
                                                                               editavel={editavel}/>}
        >
            
            <TabelaComponente colunas={comarcasColunasTabela()}
