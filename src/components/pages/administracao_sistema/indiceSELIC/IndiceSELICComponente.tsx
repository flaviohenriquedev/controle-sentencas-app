...
import {
    IndiceSELICFormularioCadastro
} from "@/components/pages/administracao_sistema/indiceSELIC/IndiceSELICFormularioCadastro";
...
const funcaoFechCadastros: (take: string, skip: string) => Promise<AxiosResponse<any, any>> = getIndiceSELIC
